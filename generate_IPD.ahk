...
FileRead, templateContent, %A_ScriptDir%\dependencies\__IPD_TEMPLATE.IPD
...
for fileName, marker in filesAndMarkers
{
    ...
    if (insertPosition)
        templateContent := SubStr(templateContent, 1, insertPosition) . "`n" . fileContent . "`n" . SubStr(templateContent, insertPosition)
}
